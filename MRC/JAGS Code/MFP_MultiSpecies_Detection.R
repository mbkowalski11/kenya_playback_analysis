...
sink("MFP_MultiSpecies_SimpProc.jags")
cat("
    model{
    ...
    logit(psi[j,t,i]) <- b0[i] + b2[i]*S.psi[j,t]
...
inits<-list(
  ...
  list(mu.a0 = runif(1,-2,2), mu.a1 = runif(1,-2,2), mu.a2 = runif(1,-2,2), mu.a3 = runif(1,-2,2), mu.b0 = runif(1,-0.5,0.5), mu.b2 = runif(1,-0.5,0.5), sig.a0 = runif(1,1,5), sig.a1 = runif(1,1,5), sig.a2 = runif(1,1,5), sig.a3 = runif(1,1,5), sig.b0 = runif(1,1,5), sig.b2 = runif(1,1,5), z = zst),
  list(mu.a0 = runif(1,-2,2), mu.a1 = runif(1,-2,2), mu.a2 = runif(1,-2,2), mu.a3 = runif(1,-2,2), mu.b0 = runif(1,-0.5,0.5), mu.b2 = runif(1,-0.5,0.5), sig.a0 = runif(1,1,5), sig.a1 = runif(1,1,5), sig.a2 = runif(1,1,5), sig.a3 = runif(1,1,5), sig.b0 = runif(1,1,5), sig.b2 = runif(1,1,5), z = zst),
  list(mu.a0 = runif(1,-2,2), mu.a1 = runif(1,-2,2), mu.a2 = runif(1,-2,2), mu.a3 = runif(1,-2,2), mu.b0 = runif(1,-0.5,0.5), mu.b2 = runif(1,-0.5,0.5), sig.a0 = runif(1,1,5), sig.a1 = runif(1,1,5), sig.a2 = runif(1,1,5), sig.a3 = runif(1,1,5), sig.b0 = runif(1,1,5), sig.b2 = runif(1,1,5), z = zst)
...
parameters <- c('a0','a1','a2','a3','b0','b2','Tobs','Tnew','Chisq.obs','Chisq.new', 'z.sum.S2','z.sum.N2', 'rho.ave', 'eleLam.C','eleLam.H','eleLam.N2.c','eleLam.N2.h','eleLam.S2.c','eleLam.S2.h','z.sum.C','z.sum.H') 
...
det.out.wZT<-jags(data = data, inits = inits, parameters.to.save = parameters, model.file = "MFP_MultiSpecies_SimpProc.jags", n.chains = nc, n.iter = ni, n.burnin = nb, n.thin = nthin, progress.bar = "text")
